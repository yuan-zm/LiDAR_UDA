...
def get_args():
    ...
    parser.add_argument(
        '--predictions', '-p',
        type=str,
        default='res_pred/syn2sk/SynLiDAR2SK_M34_XYZ_Epoch10',
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="dataset/configs/SynLiDAR2SemanticKITTI/semantic-kitti.yaml",
    ...
    parser.add_argument(
        ...
        required=False,
        default=20, # 5cm
        help='Number of classes in the dataset. Defaults to %(default)s',
    )
    parser.add_argument(
        '--dataset-name',
        type=str,
        default='SemanticKITTI',
        help='The name of present eval dataset',)
...
if __name__ == '__main__':
    ...
    if FLAGS.dataset_name == 'SemanticKITTI'or \
            FLAGS.dataset_name == 'SemanticPOSS':
